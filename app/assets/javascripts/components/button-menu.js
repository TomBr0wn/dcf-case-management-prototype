App.ButtonMenu = function(params) {
...
App.ButtonMenu.prototype.onDocumentClick = function(e) {
	if(!$.contains(this.container[0], e.target)) {
	  this.hideMenu();
  }
};

App.ButtonMenu.prototype.createToggleButton = function() {
...
App.ButtonMenu.prototype.setupResponsiveChecks = function() {
	this.mql = window.matchMedia(this.mq);
	this.mql.addListener($.proxy(this, 'checkMode'));
	this.checkMode(this.mql);
};

App.ButtonMenu.prototype.checkMode = function(mql) {
	if(mql.matches) {
		this.enableBigMode();
	} else {
...
App.ButtonMenu.prototype.enableSmallMode = function() {
...
App.ButtonMenu.prototype.enableBigMode = function() {
...
App.ButtonMenu.prototype.removeButtonClasses = function() {
...
App.ButtonMenu.prototype.addButtonClasses = function() {
	this.menu.find('.app-button-menu__item').each(function(index, el) {
...
App.ButtonMenu.prototype.hideMenu = function() {
	this.menuButton.attr('aria-expanded', 'false');
};

App.ButtonMenu.prototype.showMenu = function() {
	this.menuButton.attr('aria-expanded', 'true');
};

App.ButtonMenu.prototype.onMenuButtonClick = function() {
	this.toggle();
};

App.ButtonMenu.prototype.toggle = function() {
...
App.ButtonMenu.prototype.onMenuKeyDown = function(e) {
	switch (e.keyCode) {
		case this.keys.down:
			this.toggle();
			break;
...
App.ButtonMenu.prototype.onButtonKeydown = function(e) {
	switch (e.keyCode) {
		case this.keys.up:
			e.preventDefault();
...
App.ButtonMenu.prototype.focusNext = function(currentButton) {
...
App.ButtonMenu.prototype.focusPrevious = function(currentButton) {
